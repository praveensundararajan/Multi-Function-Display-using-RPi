...
class InstrumentPanel(QWidget):
    ...
    def initializeGauges(self):
        ...
        self.oil_display = LargeNumberDisplay(vals["oil"], "Ã‚Â°F", "Oil")

        # Initialize other displays
        # self.cht_display = LabeledValueDisplay("CHT Ã‚Â°F", "352.340")
        # self.egt_display = LabeledValueDisplay("EGT Ã‚Â°F", "1335.1274")
    ...
    def initUI(self):
        ...
        instrument_layout.setVerticalSpacing(70)  # Adjust spacing as needed
        ...
        instrument_layout.setRowMinimumHeight(1, 60)  # Fuel flow bars height
        instrument_layout.setRowMinimumHeight(2, 60)
        instrument_layout.setRowMinimumHeight(3, 60)
        instrument_layout.setRowMinimumHeight(4, 60)

        instrument_layout.setRowMinimumHeight(5, 60)  # Other gauges height
        instrument_layout.setRowMinimumHeight(6, 60)
        instrument_layout.setRowMinimumHeight(7, 60)
        instrument_layout.setRowMinimumHeight(8, 60)
        
        # Adjust the height of the fuel flow bars and other gauges
        self.fuel_flow_1.setFixedHeight(50)  # Reduce height of the fuel flow bars
        self.fuel_flow_2.setFixedHeight(50)
        self.fuel_flow_3.setFixedHeight(50)
        self.fuel_flow_4.setFixedHeight(50)

        self.oil_pressure_gauge.setFixedHeight(50)  # Reduce height of the gauges
        self.power_gauge.setFixedHeight(50)
        self.rpm_meter.setFixedHeight(50)
        self.engine_temp_gauge.setFixedHeight(50)
